...
namespace Jondo.Unity.Tests.World
{
    ...
    public class WorkshopTests
    {
        ...
        [Fact]
        public void Kex_contains_one_exchange_object_in_field_two_with_real_uid_and_quantity()
        {
            ...
            var exchangeObject = Assert.Single(entries);
            Assert.Equal(2, exchangeObject.FieldNumber);
